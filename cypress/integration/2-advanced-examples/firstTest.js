...
it('Перевод с карты на карту', () => {
  ...
  it('Example POST request', () => {
    ...
    const requestBody = {"action":"info","phone":"+380987654323","amount":300,"currency":"UAH", "cardCvv":"111","card":"4552331448138217","cardExp":"0526","xref":"1730f4049510932a253bea8fa1b6a847","_":1637313457598};
  ...
  it.only('Авторизация', () => {
    cy.visit('http://localhost:8084/')
      .get('[data-id="go-to-auth-button"]').click()
      .get('[data-id="pin-input"]')
      .type('0000')
      .get('[data-id="auth-button"]')
      .click()
